...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="{{asset('images/icon/ravvs.png')}}" alt="ravvs" />
                        </a>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="#">
                                <i class="fas fa-home"></i>RAVVS</a>
                                <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <!-- QUEM SOMOS -->
                                <li>
                                    <a href="{{route('quem-somos.nova')}}">Quem Somos</a>
                                </li>
                                <!-- CONTATO -->
                                <li>
                                    <a href="{{route('contato-ravvs')}}">Contatos da RAVVS</a>
                                </li>
                                <!-- GRUPOS DE APOIO -->
                                <li>
                                    <a href="{{route('grupos.listar')}}">Grupos de Apoio</a>
                                </li>
                            </ul>
                        </li>
                        <!-- COMUNIDADE -->
                        <li>
                            <a href="{{route('duvidas.listar')}}">
                                <i class="fas fa-home"></i>Comunidade</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="logo">
                <a href="#">
                    <img src="{{asset('images/icon/ravvs.png')}}" style="height: 50px" alt="RAVVS" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <!-- RAVVS -->
                        <li class="has-sub @if(isset($menu) && $menu == 'ravvs') active @endif">
                            <a class="js-arrow" href="#"><i class="fas fa-building"></i>RAVVS</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <!-- QUEM SOMOS -->
                                <li>
                                    <a href="{{route('quem-somos.listar')}}">Quem Somos</a>
                                </li>
                                <!-- CONTATO -->
                                <li>
                                    <a href="{{route('contato-ravvs')}}">Contato RAVVS</a>
                                </li>
                                <!-- GRUPOS de APOIO -->
                                <li>
                                    <a href="{{route('grupos.listar')}}">Grupos de Apoio</a>
                        ...
                        <!-- COMUNIDADE -->
                        <li class="has-sub @if(isset($menu) && $menu == 'comunidade') active @endif">
                            <a class="js-arrow" href="{{route('duvidas.listar')}}"><i class="fas fa-group"></i>Comunidade</a>
                        </li>
                        <!-- RELATÓRIOS -->
                        <li class="has-sub @if(isset($menu) && $menu == 'relatorio') active @endif">
